...
@available(iOS 13.0, *)
fileprivate let awsTextColor = UIColor.label
...
public class AWSViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        if #available(iOS 13.0, *) {
            self.welcomeToLabel.textColor = .label
        } else {
            // Fallback on earlier versions
        ...
        if #available(iOS 13.0, *) {
            self.appDescriptionLabel.textColor = .label
        } else {
            // Fallback on earlier versions
            self.appDescriptionLabel.textColor = UIColor(white: 0.075, alpha: 1.0)
        }
...
fileprivate class AWSItemCell: UITableViewCell {
    ...
    init(item: AWSItem) {
        ...
        if #available(iOS 13.0, *) {
            ...
            // Fallback on earlier versions
            self.itemTitleLabel.textColor = UIColor(white: 0.075, alpha: 1.0)
        }
        ...
        if #available(iOS 13.0, *) {
            self.itemDescriptionLabel.textColor = .secondaryLabel
        } else {
            // Fallback on earlier versions
            self.itemDescriptionLabel.textColor = UIColor(white: 0.075, alpha: 1.0)
        }
