//
//  FcgScolariteViewController.swift
//  exmachina
//
...
class FcgScolariteViewController: UIViewController, MFMailComposeViewControllerDelegate {
    ...
    let responsable: BtnPleinLarge = {
        ...
        cours.layer.borderColor = #colorLiteral(red: 0.9294117647, green: 0.3450980392, blue: 0.2862745098, alpha: 1).cgColor
    ...
    let attestationDeScolarite: BtnPleinLarge = {
        ...
        str.setLineSpacing(8)
        cours.setAttributedTitle(str, for: .normal)
        cours.backgroundColor = #colorLiteral(red: 0.9333333333, green: 0.4039215686, blue: 0.3490196078, alpha: 1)
        cours.layer.borderColor = #colorLiteral(red: 0.9333333333, green: 0.4039215686, blue: 0.3490196078, alpha: 1).cgColor
        cours.layer.shadowOpacity = 0.3
        cours.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1).cgColor
        cours.layer.shadowOffset = CGSize(width: 1, height: 5)
        cours.layer.cornerRadius = 10
    ...
    let attestationDeReussite: BtnPleinLarge = {
        ...
        str.setLineSpacing(8)
        cours.setAttributedTitle(str, for: .normal)
        cours.backgroundColor = #colorLiteral(red: 0.937254902, green: 0.4549019608, blue: 0.4078431373, alpha: 1)
        cours.layer.borderColor = #colorLiteral(red: 0.937254902, green: 0.4549019608, blue: 0.4078431373, alpha: 1).cgColor
        cours.layer.shadowOpacity = 0.3
        cours.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1).cgColor
        cours.layer.shadowOffset = CGSize(width: 1, height: 5)
        cours.layer.cornerRadius = 10
    ...
    let attestationDeInsciption: BtnPleinLarge = {
        ...
        str.setLineSpacing(8)
        cours.setAttributedTitle(str, for: .normal)
        cours.backgroundColor = #colorLiteral(red: 0.9450980392, green: 0.5215686275, blue: 0.4784313725, alpha: 1)
        cours.layer.borderColor = #colorLiteral(red: 0.9450980392, green: 0.5215686275, blue: 0.4784313725, alpha: 1).cgColor
        cours.layer.shadowOpacity = 0.3
        cours.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1).cgColor
        cours.layer.shadowOffset = CGSize(width: 1, height: 5)
        cours.layer.cornerRadius = 10
    ...
    let attestationDeReussiteAuDiplome: BtnPleinLarge = {
        ...
        str.setLineSpacing(8)
        cours.setAttributedTitle(str, for: .normal)
        cours.backgroundColor = #colorLiteral(red: 0.9607843137, green: 0.6392156863, blue: 0.6078431373, alpha: 1)
        cours.layer.borderColor = #colorLiteral(red: 0.9607843137, green: 0.6392156863, blue: 0.6078431373, alpha: 1).cgColor
        cours.layer.shadowOpacity = 0.3
        cours.layer.shadowColor = UIColor(red: 0, green: 0, blue: 0, alpha: 1).cgColor
        cours.layer.shadowOffset = CGSize(width: 1, height: 5)
        cours.layer.cornerRadius = 10
    ...
    func sendEmail(demande: Demande) {
        if MFMailComposeViewController.canSendMail() {
            ...
            case .Inscription?:
                ...
                mail.setToRecipients(["piecesfcg@uic.ac.ma"])
