...
class CoursesFacultyViewCell: UICollectionViewCell {
...
//        gradientBackgroundColor()
        ...
        listNameLabel.anchor(top: safeTopAnchor, left: safeLeftAnchor, bottom: nil, right: safeRightAnchor, paddingTop: 40, paddingLeft: 40, paddingBottom: 0, paddingRight: 20)
