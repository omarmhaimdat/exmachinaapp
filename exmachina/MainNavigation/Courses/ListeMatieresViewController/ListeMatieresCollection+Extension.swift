//
//  ListeMatieresCollection+Extension.swift
//  exmachina
//
...
extension ListeMatieresViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
